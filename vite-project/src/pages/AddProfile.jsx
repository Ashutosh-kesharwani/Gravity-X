...
import { FaUser, FaMapMarkerAlt, FaCode, FaLink, FaPlus, FaTrash, FaRocket, FaLock, FaArrowLeft } from 'react-icons/fa';
...
function AddProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:5000/api/profiles/add', data, {
